FROM docker.io/library/rust:1.94.0-trixie AS builder
...
RUN set -eux; \
    apt-get update; \
    apt-get install -y bash=5.2.37-2+b7 curl=8.14.1-2+deb13u2 fuse3=3.17.2-3 sqlite3=3.46.1-7+deb13u1 ca-certificates=20250419; \
    apt-get clean; \
